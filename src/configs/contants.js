import { ENVIRONMENT_FIRE_BASE_SECURITY, ENVIRONMENT_VERSION_DESKTOP  } from './environment';
...
export const PICK_IMAGE_OPTIONS = ["Huỷ", "Chọn từ bộ sưu tập ảnh", "Chụp hình"]
