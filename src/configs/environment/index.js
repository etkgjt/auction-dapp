let ENV_ENVIRONMENT_BASE_URL_API = 'https://apidev.stnhd.com/api';
let ENV_ENVIRONMENT_BASE_URL_API_FIRE_BASE = 'https://us-central1-tamtriluc-76b54.cloudfunctions.net/api';
...
let ENV_ENVIRONMENT_VERSION_DESKTOP = '1.0';
...
let ENV_ENVIRONMENT_firebaseConfig = {
  ...
  databaseURL: "https://tamtriluc-76b54-default-rtdb.asia-southeast1.firebasedatabase.app",
...
switch (process.env.NODE_ENV){
  case "development":
    ENV_ENVIRONMENT_BASE_URL_API = 'https://apidev.stnhd.com/api';
    ENV_ENVIRONMENT_BASE_URL_API_FIRE_BASE = 'https://us-central1-tamtriluc-76b54.cloudfunctions.net/api';
    ...
    ENV_ENVIRONMENT_VERSION_DESKTOP = '1.0';
