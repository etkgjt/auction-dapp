...
const Funfact = () => {
  const [didViewCountUp, setDidViewConutUp] = useState(false);

  const onVisibilityChange = (isVisible) => {
    if (isVisible) {
      setDidViewConutUp(true);
    }
  };
          ...
          <div className="row h-100 justify-content-center align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="fun-facts-image">
                <img
                  src={require('@src/assets/images/features-img2.png').default}
                  alt="image"
                />
              </div>
            </div>
            ...
            <div className="col-lg-6 col-md-12">
              <div className="fun-facts-inner-content">
                ...
                <p>
                  ...
                  retur investment alpha. Investor advisor marketing pitch gen
                  scrum project.
                </p>
                <p>
                  Responsive web design. Agile development innovator termsheet
                  is users interface pitch scrum project research & development.
                </p>
                <ul>
