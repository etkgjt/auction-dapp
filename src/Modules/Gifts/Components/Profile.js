    ...
    <div className="gifts-area">
      ...
      {isMobile ? (
        <Row>
          <Col xl="6" lg="6" md="6">
            <Row>
              ...
              <Col xs="4" sm="4">
                <a
                  onClick={() => {
                    document.getElementById("tab-gift").scrollIntoView({
                      behavior: "smooth",
                    });
                    setActiveTabs(1);
                  }}
                  className="banner-image-wrapper wow animate__animated animate__slow animate__headShake animate__infinite"
                >
          ...
          <Col xl="6" lg="6" md="6">
            <Gifts activeTab={activeTab} setActiveTabs={setActiveTabs} />
          </Col>
        </Row>
      ) : (
        <Row>
          ...
          <Col xl="5" lg="5" md="5">
            ...
            <img
              ...
              width="114%"
              height="auto"
              className="img-gift-ddcd mt-5 wow animate__animated animate__slow animate__headShake animate__infinite"
