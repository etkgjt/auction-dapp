    ...
    <section className="list-course-area list-course-section ptb-100">
      <div className="overview-section">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="list-course__item">
                ...
                >
                  <img
                    src={
                      require('@src/assets/images/list-course-img-1.png')
                        .default
                    }
                    alt="blog-image"
                  />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="list-course__item">
                ...
                >
                  <img
                    src={
                      require('@src/assets/images/list-course-img-2.png')
                        .default
                    }
                    alt="blog-image"
                  />
                ...
                <div className="list-course__content">
                  <p>
                    Huấn luyện viên trưởng Đội tuyển Siêu Trí Nhớ Việt Nam -
                    Thầy Nguyễn Phùng Phong chia sẻ Quy trình học thông minh chỉ
                    với Quy tắc 6-3-4. Các bạn cùng theo dõi nhé!
                  </p>
                </div>
                <div className="list-course__action">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="list-course__item">
                ...
                >
                  <img
                    src={
                      require('@src/assets/images/list-course-img-3.png')
                        .default
                    }
                    alt="blog-image"
                  />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="list-course__item">
                ...
                >
                  <img
                    src={
                      require('@src/assets/images/list-course-img-4.png')
                        .default
                    }
                    alt="blog-image"
                  />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="list-course__item">
                ...
                >
                  <img
                    src={
                      require('@src/assets/images/list-course-img-5.png')
                        .default
                    }
                    alt="blog-image"
                  />
                ...
                <div className="list-course__content">
                  <p>
                    Diễn đàn học tập giải đáp thắc mắc và gỡ rối những câu hỏi
                    khó nhớ chỉ cần gửi ngay lên diễn đàn. Biệt đội Siêu trí
                    tuệ, Siêu trí nhớ và Thầy cô sẽ luôn tiếp nhận và hỗ trợ.
                  </p>
                </div>
                <div className="list-course__action">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="list-course__item">
                ...
                >
                  <img
                    src={
                      require('@src/assets/images/list-course-img-6.png')
                        .default
                    }
                    alt="blog-image"
                  />
                ...
                <div className="list-course__content">
                  <p>
                    Cuộc thi 5 Phút thuộc bài-Sân chơi bổ ích dành cho học sinh
                    từ lớp 1 đến lớp 12 diễn ra hàng tuần. Các bạn học sinh được
                    vừa học vừa chơi, tranh tài và ứng dụng phương pháp học tập
                    thông minh khiến việc học trở nên đầy thú vị.
                  </p>
                </div>
                <div className="list-course__action">
        ...
        <div className="shape7">
          <img
            src={require('@src/assets/images/star1.svg').default}
            alt="shape"
          />
        </div>
        <div className="shape3">
          <img
            src={require('@src/assets/images/star3.png').default}
            alt="img"
          />
        </div>
        <div className="shape6">
          <img
            src={require('@src/assets/images/star2.svg').default}
            alt="img"
          />
        </div>
        <div className="shape8 rotateme">
          <img
            src={require('@src/assets/images/star4.svg').default}
            alt="shape"
          />
        </div>
        <div className="shape9">
          <img
            src={require('@src/assets/images/star5.svg').default}
            alt="shape"
          />
        </div>
        ...
        <div className="shape11 rotateme">
          <img
            src={require('@src/assets/images/star6.png').default}
            alt="shape"
          />
        </div>
      </div>
