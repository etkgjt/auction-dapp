      ...
      <div className="container">
        ...
        <div className="overview-box">
          <div className="row h-100 justify-content-center align-items-center">
            <div className="col-lg-6 col-md-6 overview-img">
              <img
                src={require('@src/assets/images/overview-app1.png').default}
                alt="image"
              />
            </div>
        ...
        <div className="overview-box">
          <div className="row h-100 justify-content-center align-items-center">
            <div className="col-lg-6 col-md-6 overview-img">
              <img
                src={require('@src/assets/images/overview-app3.png').default}
                alt="image"
              />
            </div>
        ...
        <div className="overview-box">
          <div className="row h-100 justify-content-center align-items-center">
            ...
            <div className="col-lg-6 col-md-6 overview-img">
              <img
                src={require('@src/assets/images/overview-app2.png').default}
                alt="image"
              />
            </div>
          </div>
        ...
        <div className="overview-box modern-flexible">
          <div className="row h-100 justify-content-center align-items-center">
            ...
            <div className="col-lg-4 col-md-12 overview-img">
              <img
                src={
                  require('@src/assets/images/feature-img-with-app.png').default
                }
                alt="image"
              />
            </div>
